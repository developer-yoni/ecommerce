...
public enum ApiCode {
	...
	CODE_000_0013(false, HttpStatus.UNPROCESSABLE_ENTITY, "INVENTORY_QUANTITY_IS_ZERO"),
	CODE_000_0014(false, HttpStatus.UNPROCESSABLE_ENTITY, "REQUEST_QUANTITY_LESS_THAN_INVENTORY_QUANTITY");
